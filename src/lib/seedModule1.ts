...
const slidesU10 = [
  { title: "Unit 1.0: The Coaching Catalyst", content: "Building the Foundation for Partnership Coaching", keyPoint: "Coaching = CATALYZING teacher growth, not CONTROLLING behavior", type: "title" },
  { title: "What is Coaching?", bullets: ["Supportive Partnership: Working WITH teachers as co-pilots in their growth journey", "Evidence-Based: Grounded in classroom observation data", "Growth-Focused: Builds capacity and celebrates progress", "Cyclical and Ongoing: Regular, sustained engagement — not a one-time visit"], keyPoint: "Coaching is not about fixing teachers — it is about unlocking their potential." },
  { title: "The Impact Cycle: 3 Phases", bullets: ["IDENTIFY — Co-select observable focus, establish baseline, set SMART goal", "LEARN — Gather evidence, co-analyze patterns, explore strategies together", "IMPROVE — Teacher tries chosen strategy, gathers new evidence, reflects and adjusts"], keyPoint: "Every coaching conversation should map to one of these three phases." },
  { title: "Coaching vs. Inspection", table: { headers: ["Feature", "Partnership Coaching", "Evaluative Inspection"], rows: [["Tone", "Supportive, growth-focused", "Judgmental, fault-finding"], ["Purpose", "Build teacher capacity", "Assess/judge performance"], ["Relationship", "Equals working together", "Hierarchical (top-down)"], ["Confidentiality", "Stays between coach-teacher", "Reported to principal"], ["Feedback", "Specific, actionable, chosen by teacher", "Corrective, prescribed by evaluator"], ["Outcome", "Teacher empowerment and skill growth", "Compliance or consequences"]] }, content: "Understanding this distinction is the first step to becoming a true Coaching Catalyst." },
  { title: "The 7 Partnership Principles", bullets: ["1. Equality — Coach is a co-learner, not an expert authority", "2. Choice — Teacher picks their own focus and strategies", "3. Voice — Teacher speaks first; coach listens deeply", "4. Dialogue — Conversation, not monologue", "5. Reflection — Teacher reflects on their own practice", "6. Praxis — Try, learn, and adjust together", "7. Reciprocity — Coach learns from the teacher too"], keyPoint: "These 7 principles are the soul of the coaching relationship." },
  { title: "Why Coaching Frequency Matters", content: "Research consistently shows that coaching frequency — not intensity — drives lasting change. Regular 2-week cycles create the feedback loops that solidify new habits.", bullets: ["Skill Development: Repeated practice in context", "Confidence Building: Teacher sees their own progress", "Reflective Practice: Systematic self-examination", "Student Learning Gains: The ultimate outcome"] },
  { title: "Confidentiality: The Non-Negotiable", content: "Coaching notes must NEVER be shared with principals, DEOs, or any evaluative authority. You are the guardian of a professional safe space.", bullets: ["Explicit agreement at the start of every coaching relationship", "Secure storage: locked cabinet or password-protected files only", "Anonymous reporting: cohort-level trends only, never individual names", "If confidentiality is breached, the coaching relationship collapses"], keyPoint: "Holding this boundary — even under pressure — is what makes you a trustworthy coach." },
  { title: "The Identity Shift", content: "Becoming a Coaching Catalyst requires a fundamental identity shift. You are no longer an inspector, evaluator, or expert. You are a growth partner.", bullets: ["From: 'I will tell you what to improve'", "To: 'We will discover together what to focus on'", "From: 'I observe and report'", "To: 'I observe and co-explore'"], keyPoint: "The hardest part of this shift is resisting the urge to give answers." },
];

const slidesU11 = [
  { title: "Unit 1.1: The Partnership Posture", content: "Shifting from a judging stance to equality-based, side-by-side partnership", type: "title" },
  ...
  { title: "The 3 Competency Pillars", bullets: ["Developmental Stance — Growth-focused; believe capacity is expandable", "Evidence-Based Approach — Observable evidence as the fuel for dialogue", "Equality Principle — Honor teacher knowledge; co-create goals as equals"], keyPoint: "Confidentiality is embedded in all three pillars." },
  { title: "The 4-Step Observation-to-Conversation Flow", bullets: ["1. OBSERVE — Collect observable behaviors (IDENTIFY phase)", "2. ASK — Curious opener to invite teacher ownership (LEARN phase)", "3. CO-INTERPRET — Share evidence; teacher interprets it first (LEARN phase)", "4. SET STEPS — Teacher chooses action + follow-up date (IMPROVE phase)"], keyPoint: "Never skip step 2. Asking before telling is the heart of partnership." },
  { title: "Partnership Language Toolkit", bullets: ["Curious Opener: 'I noticed [X] — can you tell me what you were aiming for?'", "Co-Interpretation: 'Here is what I observed. How does this align with your goals?'", "Co-Planning: 'Would you like to try strategy A or B? Let us decide together.'"], keyPoint: "Practice these phrases until they feel natural — tone matters as much as words." },
  { title: "Pakistan Context: Applying Partnership Posture", bullets: ["Urban Govt Primary, Grade 4, 78 students, no textbooks: Share what you observed about participation before asking about resources", "Rural Middle School, Grade 7 Science, broken equipment, principal watching: Maintain partnership posture even under pressure", "Multi-grade, 65 students, time-pressed: Bite-sized focus; teacher chooses one manageable area"] },
  { title: "Structured Reflection Practice", bullets: ["Step 1: Write one exact partnership phrase you will use this week", "Step 2: Ask a partner to assess your TONE (not just words)", "Step 3: Identify one Judge habit you want to break", "Step 4: Make a public commitment to your accountability partner"], keyPoint: "Reflection without action is just thinking. Make the commitment specific and observable." },
];

const slidesU12 = [
  { title: "Unit 1.2: The Shared Mirror", content: "Presenting classroom data as a neutral starting point for collaborative discovery", type: "title" },
  { title: "What is the Shared Mirror?", content: "A coaching practice where the coach presents observation data so that both coach and teacher can explore teaching and learning together — without judgment.", table: { headers: ["Approach", "Description"], rows: [["Old Way (Audit)", "Coach observes → decides → prescribes → teacher complies"], ["New Way (Shared Mirror)", "Coach observes → shares neutral data → both interpret → teacher chooses → coach supports"]] }, keyPoint: "A mirror reflects reality without judgment. A SHARED mirror means we look at the reflection TOGETHER." },
  { title: "4 Steps of the Shared Mirror", bullets: ["1. Collect Observations — raw data, time-stamped, no interpretation", "2. Organize Patterns — group related observations to find themes", "3. Share Neutrally — facts + timestamps, zero judgment language", "4. Co-Interpret & Agree — teacher selects focus and action"], keyPoint: "Steps 3 and 4 are where the Shared Mirror actually happens." },
  { title: "Do vs. Avoid", table: { headers: ["Action", "Do (Shared Mirror)", "Avoid (Judging Stance)"], rows: [["Data Sharing", "Time-stamped facts", "Labels and judgments"], ["Questioning", "Curious, reflective questions", "Immediate prescriptions"], ["Tone", "Exploratory — 'Let us look at this together'", "Deficit language"], ["Interpretation", "Invite teacher to interpret first", "Lead with coach's opinion"], ["Next Steps", "Teacher selects focus and strategy", "Coach prescribes solution"]] } },
  { title: "Low-Inference vs. High-Inference Language", bullets: ["LOW-INFERENCE (Use): 'At 10:15, you asked 4 questions. 3 of the same students responded each time.'", "HIGH-INFERENCE (Avoid): 'Most students were not engaged with your lesson.'", "LOW-INFERENCE (Use): 'In 20 minutes of group work, I counted 7 blank worksheets.'", "HIGH-INFERENCE (Avoid): 'Students did not understand the task you gave them.'"], keyPoint: "Low-inference language invites curiosity. High-inference language triggers defensiveness." },
  { title: "Shared Mirror + Impact Cycle", bullets: ["IDENTIFY: Neutral data reveals the current reality of the classroom", "LEARN: Co-interpretation surfaces insights and informs strategy selection", "IMPROVE: Collaborative next steps are measured using the same neutral approach"], content: "The Shared Mirror is the tool that makes the Impact Cycle feel collaborative rather than evaluative." },
  { title: "Audit Culture in Pakistan: The Real Challenge", content: "Teachers in Pakistan often expect judgment. AEOs and DEOs have used observations to evaluate and punish.", bullets: ["When teachers expect judgment → they hide struggles, blame students, implement superficially", "When they experience shared exploration → they share authentic challenges and own their growth", "Your job is to break the audit culture pattern — one conversation at a time"], keyPoint: "The Shared Mirror is an act of resistance against audit culture." },
];

const slidesU13 = [
  { title: "Unit 1.3: The Growth Engine", content: "Operationalizing the Impact Cycle through a 4-step evidence-based partnership process", type: "title" },
  { title: "The 4-Step Coaching Cycle", bullets: ["1. PLAN — Co-select observable focus, set SMART goal (IDENTIFY phase)", "2. OBSERVE — Collect focused, concrete evidence with timestamps (IDENTIFY phase)", "3. CO-ANALYSE — Share evidence neutrally, invite teacher to interpret, co-identify growth area (LEARN phase)", "4. SUPPORT — Invite teacher solutions, teacher chooses, set 2-week revisit (IMPROVE phase)"], keyPoint: "Teacher choice is not optional — it is the engine of the whole cycle." },
  { title: "Evidence vs. Interpretation", table: { headers: ["Evidence (Use This)", "Interpretation (Avoid This)"], rows: [["'10:15am — Teacher asks question; 12 students raise hands'", "'Students weren't engaged with the lesson'"], ["'In 20 minutes, 4 students answered all 8 questions asked'", "'Only a few students understand the content'"], ["'Teacher modeled 3 problems, then gave 5 independent practice problems'", "'Teacher did not give enough practice time'"], ["'7 worksheets were blank at end of group work'", "'Students did not understand the task'"]] }, keyPoint: "Evidence is observable and specific. Interpretation is subjective and triggering." },
  { title: "Step 3: Co-Analysis", bullets: ["1. Share Evidence — neutral, descriptive language with timestamps", "2. Ask — curious opener with minimum 5-second wait time", "3. Co-Identify Growth Area — teacher names the area; coach does not impose it"], content: "Example: 'I noticed that 4 students answered 80% of the questions. What is your reading of that pattern?'", keyPoint: "The teacher naming the growth area is 10x more powerful than the coach naming it." },
  { title: "Step 4: Co-Creating the Action Plan", bullets: ["Old Way: 'Here is what you need to do this week'", "Partnership Way: 'What strategy would you like to try?'", "Sequence: Invite → Offer options if stuck → Teacher chooses → Co-plan follow-up", "Action must be: bite-sized, observable, and achievable in 2 weeks"], keyPoint: "If the teacher did not choose the action, they will not own its implementation." },
  { title: "Partnership Principles in Each Cycle Step", table: { headers: ["Cycle Step", "Partnership Principles in Action"], rows: [["PLAN", "Choice + Voice — teacher defines the focus"], ["OBSERVE", "Reflection — data collected to enable teacher reflection"], ["CO-ANALYSE", "Dialogue + Equality — mutual interpretation as partners"], ["SUPPORT", "Praxis + Reciprocity — teacher tries, coach learns too"]] } },
  { title: "Handling Resistance: 4 Real Cases", bullets: ["'I am too busy. Just tell me what to fix.' → Acknowledge time pressure. Offer to focus on just one thing.", "Principal demands coaching notes → Hold the boundary. Offer school-wide trends instead.", "Coaching 18 teachers — how to prioritize? → Focus on highest leverage with most willingness.", "Teacher chooses an ineffective strategy → Let them try it. The next cycle reveals evidence together."], keyPoint: "Resistance is information. Approach it with curiosity, not pressure." },
];

const slidesU14 = [
  { title: "Unit 1.4: The Trust Bridge", content: "Building the Foundation of Ethical Partnership Coaching through confidentiality and trust", type: "title" },
  { title: "Why Trust is the Foundation", table: { headers: ["Without Trust", "With Trust"], rows: [["Teacher hides struggles, sugar-coats reality (IDENTIFY fails)", "Teacher shares authentic challenges"], ["Teacher becomes defensive, blames students (LEARN fails)", "Teacher reflects openly on their practice"], ["Teacher complies but reverts when coach leaves (IMPROVE fails)", "Teacher owns and sustains change"]] }, keyPoint: "No trust → No Impact Cycle → No student learning gains." },
  { title: "The 4-Pillar Ethical Framework", bullets: ["1. TRUST — Does this action build or undermine trust? Red flag: teacher feels judged, exposed, or controlled", "2. CONFIDENTIALITY — Am I protecting coaching data from evaluative use? Red flag: sharing notes, staffroom talk", "3. ACCOUNTABILITY — Am I clear about role boundaries? Red flag: becoming the principal's informant", "4. INTEGRITY — Does this align with Partnership Principles? Red flag: imposing solutions or telling teachers what to fix"], keyPoint: "Run every ethical decision through all 4 pillars before acting." },
  { title: "5 Types of Confidentiality Breaches", bullets: ["1. Undefined Boundaries — no explicit confidentiality conversation at the start", "2. Unprotected Access — notebook visible, shared passwords, open files", "3. Casual Mentions — staffroom conversation about a teacher's struggles", "4. Principal Reporting — sharing coaching notes for evaluation", "5. Comparing Teachers — naming who is strong or weak to others"], keyPoint: "Any of these five breaches can destroy a coaching relationship permanently." },
  { title: "The Confidentiality Agreement", content: "Every coaching relationship must begin with an explicit confidentiality agreement covering:", bullets: ["What data will be collected and how it is stored", "Who has access (answer: only the teacher and coach)", "How reporting works (anonymous, cohort-level trends only)", "Exceptions: legal obligations only (child safety, serious harm)"], keyPoint: "Have this conversation in the first meeting. Do not assume confidentiality is understood." },
  { title: "4 Trust-Building Behaviors", bullets: ["1. Share evidence, not judgment — 'I observed X' not 'You did not do Y well'", "2. Ask before telling — teacher speaks first, always", "3. Honor teacher choice — even if you disagree with their strategy", "4. Acknowledge what is working — start with strengths, not gaps"], keyPoint: "Trust is built slowly through 100 small consistent actions, and destroyed quickly by one breach." },
  { title: "Handling Principal Pressure", content: "A head teacher requests your coaching notes on 5 teachers for performance reviews.", bullets: ["'I appreciate your interest. My role is coaching support, not evaluation.'", "'I can share school-wide themes where multiple teachers are working on similar goals.'", "'Sharing individual coaching notes would breach confidentiality and undermine the trust that makes coaching effective.'", "Offer alternative: aggregate themes, not individual data"], keyPoint: "You are the guardian of the professional safe space. Hold this boundary — it is not optional." },
];

const slidesU15 = [
  { title: "Unit 1.5: The Human Filter", content: "Using AI as a partnership tool, not a replacement for human professional judgment", type: "title" },
  { title: "AI: Opportunity and Risk", table: { headers: ["AI Opportunity", "AI Risk"], rows: [["Tracks patterns over time humans miss", "Misses classroom context entirely"], ["Provides objective frequency data", "Reinforces Western dataset bias"], ["Identifies trends across many teachers", "Undermines partnership if misused"], ["Reduces observer memory errors", "Audit Culture 2.0 — new inspector"]] }, keyPoint: "AI provides DATA PATTERNS → Human adds CONTEXT → Together = PARTNERSHIP-ALIGNED FEEDBACK" },
  { title: "AI in the Impact Cycle", bullets: ["IDENTIFY: AI tracks patterns + human adds 'why' context from knowing the teacher", "LEARN: AI data is a conversation starter, not a conclusion", "IMPROVE: AI tracks what teacher tried + human ensures teacher owns strategy selection"], keyPoint: "AI should accelerate the Impact Cycle, not replace human judgment in it." },
  { title: "The 3-Question AI Validation Framework", bullets: ["1. CONTEXT — Does this account for the classroom reality I observed? (class size, resources, curriculum pressure, teacher intent)", "2. BIAS — Could this reflect algorithm bias or cultural assumptions? (Western dataset, deficit framing)", "3. PARTNERSHIP — Does this preserve teacher choice, voice, and agency?"], keyPoint: "If ANY of the 3 questions raises a concern → ADD CONTEXT or OVERRIDE the AI suggestion." },
  { title: "Pakistan-Specific AI Override Examples", bullets: ["AI says 'use digital tools' → School has no electricity. OVERRIDE.", "AI flags 40-min review as 'below pacing benchmark' → Teacher intentionally slowed for comprehension. ADD CONTEXT.", "AI flags 'no differentiation' → 75 students, no teaching assistant. OVERRIDE.", "AI flags 'below benchmark' for teacher with 90 students doing exceptional work. OVERRIDE."], keyPoint: "You know the classroom. The AI does not." },
  { title: "AI Limitations You Must Know", bullets: ["Training Bias — AI trained on Western classroom data; penalizes Pakistan realities", "Cultural Blindness — misinterprets teacher authority, collective learning, Urdu-medium instruction", "Deficit Framing — AI often focuses on what is wrong rather than growth opportunities", "Technical Errors — AI is not infallible; anomalous data produces anomalous suggestions"], keyPoint: "Professional judgment always supersedes AI output. You are the Human Filter." },
  { title: "When AI Becomes the New Inspector", content: "The greatest risk: AI data used for evaluation → teachers close off → trust destroyed → coaching fails.", bullets: ["Prevention 1: Establish clear boundaries with principals before introducing AI tools", "Prevention 2: Clarify — AI data is a coaching tool only, never an evaluation input", "Prevention 3: Share AI data WITH the teacher first, not with administrators", "Prevention 4: Apply the 3-Question Framework before sharing any AI output"], keyPoint: "Your role is to be the Human Filter that prevents AI from becoming Audit Culture 2.0." },
];

const slidesU16 = [
  { title: "Unit 1.6: Coding the Classroom", content: "Using the I Do/We Do/You Do/CFU Observation Schema as a Partnership Tool", type: "title" },
  { title: "The Observation Schema", table: { headers: ["Phase", "Description", "Coach Observes"], rows: [["I DO (Teacher Models)", "Teacher demonstrates; students observe", "Time, clarity, think-aloud quality"], ["WE DO (Guided Practice)", "Students practice WITH teacher support", "Teacher circulation, feedback quality"], ["YOU DO (Independent Practice)", "Students apply independently", "Student engagement, teacher monitoring"], ["CFU (Check for Understanding)", "Can happen in ANY phase", "Question type, student response spread"]] }, keyPoint: "Schema describes lesson structure — it does NOT judge teaching quality." },
  { title: "Schema → Impact Cycle", bullets: ["IDENTIFY: Code current lesson structure (e.g., 25 min I Do, 5 min You Do = baseline pattern)", "LEARN: Schema data becomes the conversation starter — teacher explains their intent", "IMPROVE: Track what the teacher tries next cycle, compare schema across lessons over time"], keyPoint: "Two lessons with identical schema codes can be completely different in quality." },
  { title: "Pakistan Example: Grade 4 Maths, 68 Students", bullets: ["9:00–9:20: I DO — Teacher models 12×4, thinks aloud in Urdu (20 min)", "9:20–9:30: WE DO — Students in pairs: 15×3, teacher circulates (10 min)", "9:30–9:40: YOU DO — 5 textbook problems independently on slates (10 min)", "9:40–9:45: CFU — Students show slates for problem #3 (5 min)"], keyPoint: "Total: 20/10/10/5 — a reasonable starting baseline for this class size." },
  { title: "The Partnership Way: Sharing Schema Data", bullets: ["Step 1: Share Data — 'I coded 20 min I Do, 5 min We Do, 10 min You Do, 5 min CFU'", "Step 2: Invite Interpretation — 'What was your thinking about the lesson structure today?'", "Step 3: Co-Explore — Teacher explains intent; together decide if adjustment is wanted"], table: { headers: ["Old Way", "Partnership Way"], rows: [["'You talked too much'", "'I coded 20 min I Do. What was driving that structure today?'"], ["'Students needed more practice'", "'The You Do was 5 minutes. Is that what you intended?'"]] } },
  { title: "What Schema Can and Cannot Tell You", table: { headers: ["Schema CAN Show", "Schema CANNOT Show"], rows: [["Time allocation across phases", "Teaching quality within a phase"], ["Presence or absence of phases", "Student engagement or understanding"], ["Patterns across multiple lessons", "Cultural responsiveness"], ["Changes in structure over time", "Whether structure matched student needs"]] }, keyPoint: "Use schema to open dialogue, not to render verdicts." },
...
const quizU15 = [
  { q: "The 'Human Filter' concept means:", options: ["Filtering out negative AI suggestions before sharing them with teachers", "The coach must validate and contextualise AI suggestions before using them", "Using human observation data instead of AI data wherever possible", "Filtering AI reports through school management before coaches access them"], correct: 1 },
